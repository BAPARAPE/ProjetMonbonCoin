      ...
      <div class="container">
        ...
        <div class="card mb-3 border-0 rounded-0">
            <div class="row">
              ...
              <div class="col-md-7">
                <div class="card-body ">
                <h2 class="card-title "><a class="nom" href='details.php?vid=<?=$vid?>'><?=$Nomm?></a></h5>
                  <p class="card-text fs-4 "><?=$Venlo ?></p>
                  <h4 class="card-title mb-5"><?=$Prix ?>$</h4>
                </div>
                <div>
                  <p class="card-text smal"><small class="text-muted smal"><?=$Ville?></small><a class="nom2" href='action_get.php?vid=<?=$vid?>'><i class="fa-regular fa-2x smale fa-heart"></i></a></p>
                </div>
              </div>
            </div>
        </div>
